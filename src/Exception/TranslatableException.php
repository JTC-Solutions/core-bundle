...
abstract class TranslatableException extends Exception
{
     ...
     * @param non-negative-int $statusCode The HTTP status code that should be associated with this exception in API responses.
     ...
     *
     * @return non-negative-int The HTTP status code.
     */
